import { JsonObject, HumanDuration as HumanDuration$1 } from '@backstage/types';
import { Config } from '@backstage/config';
import { Duration } from 'luxon';
import { LegacyRootDatabaseService, PluginDatabaseManager } from '@backstage/backend-common';
 ...
 */
type TaskFunction = ((abortSignal: AbortSignal) => void | Promise<void>) | (() => void | Promise<void>);
/**
...
interface TaskScheduleDefinition {
     ...
     */
    initialDelay?: Duration | HumanDuration$1;
    /**
 ...
 */
interface TaskScheduleDefinitionConfig {
    /**
     * How often you want the task to run. The system does its best to avoid
     * overlapping invocations.
     *
    ...
    frequency: {
         ...
         */
        cron: string;
    } | string | HumanDuration$1;
    /**
     * The maximum amount of time that a single task invocation can take, before
     * it's considered timed out and gets "released" such that a new invocation
     * is permitted to take place (possibly, then, on a different worker).
     */
    timeout: string | HumanDuration$1;
    /**
     * The amount of time that should pass before the first invocation happens.
     *
     * @remarks
     ...
     * reach some equilibrium at startup before triggering heavy batch workloads.
     */
    initialDelay?: string | HumanDuration$1;
    /**
     * Sets the scope of concurrency control / locking to apply for invocations of
     * this task.
     *
 ...
 */
declare function readTaskScheduleDefinitionFromConfig(config: Config): TaskScheduleDefinition;
...
declare class TaskScheduler {
    ...
    constructor(databaseManager: LegacyRootDatabaseService, logger: LoggerService);
    /**
 ...
 */
type HumanDuration = HumanDuration$1;

export { type HumanDuration, type PluginTaskScheduler, type TaskDescriptor, type TaskFunction, type TaskInvocationDefinition, type TaskRunner, type TaskScheduleDefinition, type TaskScheduleDefinitionConfig, TaskScheduler, readTaskScheduleDefinitionFromConfig };
